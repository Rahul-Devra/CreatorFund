    ...
    <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="m-auto md:w-8/12 lg:w-6/12 xl:w-6/12">
          <div className="rounded-xl bg-slate-950 shadow-xl p-6 sm:p-16">
            ...
            <div className="mt-12 space-y-4 text-white text-center">
              <p className="text-xs">
                By proceeding, you agree to our <a href="#" className="underline">Terms of Use</a> and confirm you have read our <a href="#" className="underline">Privacy and Cookie Statement
                </a>
                .
              </p>
              <p className="text-xs">
